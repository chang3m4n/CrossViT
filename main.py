...
def get_args_parser():
    ...
    parser.add_argument('--batch-size', default=32, type=int)  # 减小批量大小以加快每个迭代速度
    parser.add_argument('--epochs', default=100, type=int)  # 减少训练轮数
    ...
    parser.add_argument('--aa', type=str, default=None, metavar='NAME',  # 禁用复杂的AutoAugment
    ...
    parser.add_argument('--reprob', type=float, default=0.0, metavar='PCT',
                        help='Random erase prob (default: 0.0)')  # 禁用Random Erase
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default=os.path.join('./dataset'), type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='FLOWER', choices=['FLOWER','CIFAR10', 'CIFAR100', 'IMNET', 'INAT', 'INAT19'],
    ...
    parser.add_argument('--num_workers', default=4, type=int)  # 调整工作线程数量，避免过多线程竞争资源
...
def main(args):
    ...
    if args.initial_checkpoint:
        ...
        if 'model' in checkpoint:
            ...
            utils.load_checkpoint(model, checkpoint)
